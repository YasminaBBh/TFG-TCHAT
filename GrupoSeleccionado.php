...
if ($grupo) {
?>
  <div class="row align-items-center px-3 py-2 barUser" id="grupo" >
    <div class="col-auto d-flex align-items-center">
      <a href="home.php" class="me-3 text-white" style="text-decoration: none;">
  ...
  <div class="row reply" id="formnormal">
    <form class="conversation-compose" id="formenviarmsj" name="formEnviaMsj">
      ...
      <input class="input-msg" name="mensaje" id="mensaje" placeholder="Escribe tu Mensaje..." autocomplete="off" required>
...
<script type="text/javascript">
  $(function () {
    ...
    $("#formenviarmsj").on('keydown', function (e) {
    ...
    $("#botonenviarMensaje").on('click', function (e) {
      e.preventDefault();
      enviarMensaje();
    });
  ...
  function eliminarGrupo(id) {
    if (confirm("¿Estás seguro de que deseas eliminar este grupo?")) {
      $.ajax({
        type: "POST",
        url: "acciones/eliminarGrupo.php",
        dataType: "json",
        data: JSON.stringify({ id_grupo: id, id_conectado: "<?php echo $idConectado; ?>" }),
